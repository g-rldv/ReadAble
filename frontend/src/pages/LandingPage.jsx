...
import { BookOpen, Zap, Heart, Star, ArrowRight, Volume2 } from 'lucide-react';

// Mini trial game: picture-word matching
const TRIAL_ITEMS = [
    ...
    <div className="min-h-screen" style={{ background: 'var(--bg-primary)' }}>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-12 pb-8 grid lg:grid-cols-2 gap-12 items-center">
        <div className="animate-slide-up">
          ...
          <div className="flex flex-wrap gap-3 mt-8">
            {['🎮 Fun Games', '🔊 Read-Aloud', '📊 Progress Tracking', '🏆 Achievements', '♿ Accessible'].map(f => (
              <span key={f} className="px-3 py-1 rounded-full bg-white dark:bg-gray-800 shadow-sm text-sm font-semibold text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-600">
                {f}
              </span>
            ))}
          </div>
        ...
        <div className="animate-pop">
          <div className="rounded-3xl p-6 shadow-xl border-2 border-sky/20"
            ...
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-display text-xl text-gray-800 dark:text-gray-200">
                🎮 Try a Quick Game!
              </h3>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { icon: '🎮', color: 'from-coral/20 to-coral/5', title: 'Fun Word Games', desc: 'Match words, fill blanks, sort sentences — learning feels like play!' },
            { icon: '🔊', color: 'from-sky/20 to-sky/5', title: 'Read Aloud', desc: 'Every activity can be read to you using natural-sounding voices.' },
            { icon: '📈', color: 'from-mint/20 to-mint/5', title: 'Track Progress', desc: 'Level up, earn badges, and watch your skills grow over time.' },
            { icon: '🎨', color: 'from-grape/20 to-grape/5', title: 'Customisable', desc: 'Adjust text size, switch themes, and make it work for you.' },
            { icon: '♿', color: 'from-sunny/20 to-sunny/5', title: 'Accessible Design', desc: 'Built with everyone in mind — simple, clear, and easy to use.' },
            { icon: '🏆', color: 'from-coral/20 to-sunny/10', title: 'Earn Rewards', desc: 'Collect badges and climb the leaderboard as you learn!' },
